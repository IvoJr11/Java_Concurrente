...
public class FarmaciaManager {
  ...
  public void colocarFichaGeneral() {
    ...
    try {
      ...
      System.out.println("Aniadida ficha general");
      System.out.println("Fichas generales: " + fichasGen.size());
  ...
  public void tomarFichasContable(char tipo) throws Exception {
    ...
    try {
      if(tipo == 'G') {
        ...
        System.out.println("Contable toma ficha de generales");
        ...
        System.out.println("Contable toma ficha de contables");
  ...
  public void tomarFichasEncargado(char tipo) throws Exception {
    ...
    try {
      if(tipo == 'G') {
        ...
        System.out.println("Encargado toma ficha de generales");
        receta = fichasGen.peek();
        fichasGen.remove();
      } else {
        while (fichasEnc.isEmpty()) {
          colaCondicion.await();
        }
        System.out.println("Encargado toma ficha de encargados");
        receta = fichasEnc.peek();
        fichasEnc.remove();
      }
    } finally {
      lockLocal.unlock();
